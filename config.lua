...
Config.check_updates = true, -- false = Off
...
-- WEBHOOK
Config.Discord = '' -- Your Server invite link.
Config.EnableDiscordLink = false -- Default : false | Only turn this on if you want to link the logs to a discord
Config.webhookban = '' -- Webhook link for Ban Logs
Config.webhookunban = '' -- Webhook link for Un-Ban logs
Config.green = 56108
Config.grey = 8421504
Config.red = 16711680
...
Config.CarsBL = { -- I will add some that should be blacklisted anyways as a template
"vigilante",
"hydra",
"buzzard",
"deluxo",
...
Config.WeaponBL = { -- I will add some that should be blacklisted anyways as a template
"WEAPON_RAILGUN",
"WEAPON_GARBAGEBAG",
"WEAPON_RPG",
"WEAPON_MINIGUN",
...
Config.ObjectsBL = { -- This list is huge but add more if you want.
